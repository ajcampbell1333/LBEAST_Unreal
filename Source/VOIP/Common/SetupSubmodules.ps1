# LBEAST VOIP - Setup Git Submodules Script
# 
...
#   - Run from LBEAST_UnrealPlugin/Plugins/LBEAST directory

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "LBEAST VOIP - Setup Git Submodules" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host "     - Edit → Plugins → Search 'LBEAST VOIP' → Enable" -ForegroundColor Gray
