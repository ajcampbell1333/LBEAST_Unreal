 ...
 * 
 * Communication Protocol: Binary LBEAST protocol
 * 
...
// - LBEAST_Wireless_RX.h for receiving commands
// - LBEAST_Wireless_TX.h for sending telemetry
