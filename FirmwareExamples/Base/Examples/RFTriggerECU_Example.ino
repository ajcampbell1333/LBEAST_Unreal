/*
 * LBEAST RF Trigger ECU Example Firmware
 * 
 * This example demonstrates bidirectional 433MHz RF communication for wireless
 * button/remote control integration with LBEAST EmbeddedSystems API.
 * 
 * Functionality:
 ...
 * 
 * Protocol: Binary LBEAST protocol (WiFi UDP to Unreal Engine)
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n\nLBEAST RF Trigger ECU Example Starting...");
